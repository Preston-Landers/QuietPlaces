...
package edu.utexas.quietplaces.receivers;
...
import edu.utexas.quietplaces.utils.GingerbreadLastLocationFinder;
...
public class PassiveLocationChangedReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (intent.hasExtra(key)) {
            ...
            GingerbreadLastLocationFinder lastLocationFinder = new GingerbreadLastLocationFinder(context);
